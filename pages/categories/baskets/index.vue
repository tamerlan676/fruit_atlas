<template lang="pug">
.category
    Breadcrumbs(:razdel="razdel" currentPage="Фруктовые наборы")
    .category-info
        h1.title Заказывайте фруктовые корзины быстрой и удобной доставкой на дом 
    .category-flex
  ...
  <script>
    export default{
      ...
      head(){
        return {
          title: '🧺 Доставка фруктовых корзин на дом в Москве',
          meta: [
            { charset: 'utf-8' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            {
              hid: 'description',
              name: 'description',
              content: 'Заказывайте фруктовые корзины в нашем интернет магазине. Мы обеспечим быструю и удобную доставку. Ваши близкие останутся довольны вкусом и свежестью наших фруктов'
            }
          ],
        }
      },
