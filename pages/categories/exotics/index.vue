...
.category
  ...
  <script>
    export default{
      ...
      head(){
        return {
          title: 'Заказать экзотические фрукты с доставкой на дом',
          meta: [
            { charset: 'utf-8' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            {
              hid: 'description',
              name: 'description',
              content: 'Заказывайте экзотические фрукты в нашем интернет магазине. Мы обеспечим быструю и удобную доставку'
            }
          ],
        }
      },
