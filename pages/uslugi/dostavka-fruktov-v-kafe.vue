...
.main 
    ...
    export default{
      data() {
        return {
          heroTitle: `Доставка фруктов в кафе и рестораны`,
          heroDesc: `Мы рады предложить услуги по оптовым поставкам фруктов и овощей для кафе, ресторанов и других предприятий общественного питания в Москве. Наша молодая, но динамично развивающаяся компания готова обеспечить ваше заведение самыми свежими и качественными продуктами в кратчайшие сроки.`,
          ...
          chessList: [
            ...
            },
            {
              ...
              desc: 'Понимая специфику ресторанного бизнеса, мы принимаем заказы в самые сжатые сроки. Утренняя доставка по заявкам, оформленным до вечера предыдущего дня - оптимальный вариант для большинства заведений. При необходимости мы организуем экстренные поставки день в день.',
              img: require('~/assets/images/gibko.jpg')
            },
            {
              title: 'Разные ценовые сегменты',
              desc: 'У нас вы найдете продукцию, которая впишется в концепцию вашего кафе или ресторана. Недорогие овощи и фрукты для демократичных столовых, отборные и редкие сорта для статусных ресторанов - мы подберем оптимальное предложение под ваш бюджет и аудиторию.',
      ...
      head(){
        return {
          title: '✅ Доставка фруктов в кафе и рестораны по Москве',
          meta: [
            { charset: 'utf-8' },
