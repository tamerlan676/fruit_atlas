...
export default{
  data() {
    return {
      heroTitle: `Доставка фруктовых корзин по Москве`,
      heroDesc: `Предлагаем быструю и удобную доставку фруктовых корзин прямо к вашему порогу. <br>Свяжитесь с нами и мы раскажем вам все подробности`,
      ...
      img: require('~/assets/images/basket.jpg'),
      showPopup: false
    }
  },
  head(){
        return {
          title: 'Фруктовые корзины с доставкой на дом',
          meta: [
            { charset: 'utf-8' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            {
              hid: 'description',
              name: 'description',
              content: 'Заказжите фруктовые корзины в нашем интернет магазине. Мы обеспечим быструю и удобную доставку'
            }
          ],
        }
      },
